...
- `PATCH /integrations/payable/:id` - Atualizar pagável
- `DELETE /integrations/payable/:id` - Excluir pagável
- `POST /integrations/payable/batch` - Processar lote de pagáveis
